...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-fieldservice_account_payment>=16.0dev,<16.1dev',
        ...
        'odoo-addon-fieldservice_digitized_signature>=16.0dev,<16.1dev',
        ...
        'odoo-addon-fieldservice_stock_picking>=16.0dev,<16.1dev',
